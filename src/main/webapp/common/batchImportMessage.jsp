...
$(document).ready(function() {
	...
	function onekeyRecover(){
		var history_id ="${history_id}"||"";
		var id = "${id}"||"";
		console.log(history_id);

		if(!!history_id){
			window.location.href="<%=basePath%>/onekeyRecover?id="+history_id+"&parent_id="+id;
		}else{
			if(navigator.userAgent.toUpperCase().indexOf("CHROME") === -1){
				history.back();
			}
...
<body>
	<div id="tips"></div>
	<a href="#" class="backBtn" onclick="javascript:onekeyRecover();">一键恢复</a>
